...
const CurrentTrip = ({ navigation }) => {
  ...
  const confirmCancel = () => {
    Alert.alert(
      "Viaje Cancelado",
      "Tu viaje ha sido cancelado con éxito",
      [{ text: "OK" }]
    );
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>VIAJE ACTUAL</Text>
      </View>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => Alert.alert('Bosa donde la gente goza')}
      >
      ...
      <View style={styles.tripInfoContainer}>
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoText}>Tiempo estimado: 12 min</Text>
        </View>

        <View style={styles.infoItem}>
          <Ionicons name="cash-outline" size={24} color="#0088FF" />
          <Text style={styles.infoText}>Costo total: $120.00</Text>
        </View>
